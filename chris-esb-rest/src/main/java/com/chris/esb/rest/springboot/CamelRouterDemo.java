...
@Component
public class CamelRouterDemo extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        rest("/getParks").consumes("application/json")
                .produces("application/json").
                post().to("direct:queryParks");
        ...
        from("direct:queryParks")
                .to("http://localhost:8086/basepark/list.notoken?bridgeEndpoint=true")
